function hideYoucityList() {
    $('#city_win .youcity_content').stop().animate({opacity: 0, top: "-=170",}, 300, function () {
        $('#city_win').hide();
    })
}
function showYoucityList() {
    $('#city_win').show();
    $('#city_win .youcity_content').stop().animate({opacity: 1, top: "+=170",}, 300)
}
function hideYoucityAsk() {
    $('.Youcity_ask').hide();
}
function showYoucityAsk() {
    $('.Youcity_ask').show();
}
...
$(document).ready(function () {
    ...
    $('#city_select_link, [data-youcity]').on('click', function (e) {
        e.preventDefault();
        showYoucityList();
    });
...
function deleteYoucityCookie(name) {
